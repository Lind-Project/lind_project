...
RUN pacman -Syu --noconfirm base-devel python2 python2-pip python2-setuptools python2-virtualenv subversion git rsync make autotools gcc-libs lib32-gcc-libs
