...
srcdir='.'
CC='gcc'
CFLAGS='-march=native -g3 -O3 -fuse-ld=gold -fuse-linker-plugin -fno-strict-aliasing -fno-plt -fPIC -Wno-error -Wno-implicit-fallthrough -march=x86-64 -mtune=intel -g3 -O3 -fno-plt -fno-strict-aliasing -fPIC -fuse-linker-plugin -fuse-ld=gold'
CPPFLAGS=''
LDFLAGS='-march=native -g3 -O3 -fuse-ld=gold -fuse-linker-plugin -fno-strict-aliasing -fno-plt -fPIC -Wno-error -Wno-implicit-fallthrough -march=x86-64 -mtune=intel -g3 -O3 -fno-plt -fno-strict-aliasing -fPIC -fuse-linker-plugin -fuse-ld=gold -Wl,--as-needed,--sort-common,--warn-common'
ALLOCA=''
LOADLIBES=' '
eval extras=\'\'
REMOTE='stub'
