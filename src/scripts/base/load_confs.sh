...
cp /home/lind/lind_project/hosts /home/lind/lind_project/src/safeposix-rust/tmp/etc/hosts
...
cp /etc/resolv.conf /home/lind/lind_project/src/safeposix-rust/tmp/etc/resolv.conf
cp /etc/nsswitch.conf /home/lind/lind_project/src/safeposix-rust/tmp/etc/nsswitch.conf
cp /etc/host.conf /home/lind/lind_project/src/safeposix-rust/tmp/etc/host.conf
cp /usr/share/zoneinfo/America/New_York /home/lind/lind_project/src/safeposix-rust/tmp/etc/localtime 
