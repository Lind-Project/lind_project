...
#define HAVE_floatdisf2_i387_with_xmm (TARGET_80387 && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES \
   && !TARGET_64BIT && optimize_function_for_speed_p (cfun))
#define HAVE_floatdidf2_i387_with_xmm (TARGET_80387 && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES \
   && !TARGET_64BIT && optimize_function_for_speed_p (cfun))
#define HAVE_floatdixf2_i387_with_xmm (TARGET_80387 && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES \
   && !TARGET_64BIT && optimize_function_for_speed_p (cfun))
...
#define HAVE_ashrdi3_63_rex64 (TARGET_64BIT && INTVAL (operands[2]) == 63 \
...
#define HAVE_set_got_offset_rex64 (TARGET_64BIT)
#define HAVE_eh_return_si (Pmode == SImode)
#define HAVE_eh_return_di (Pmode == DImode)
#define HAVE_leave (!TARGET_64BIT)
#define HAVE_leave_rex64 (TARGET_64BIT)
#define HAVE_ctzsi2 1
#define HAVE_ctzdi2 (TARGET_64BIT)
#define HAVE_clzsi2_abm (TARGET_ABM)
...
#define HAVE_clzdi2_abm (TARGET_64BIT && TARGET_ABM)
#define HAVE_clzhi2_abm (TARGET_ABM)
...
#define HAVE_allocate_stack_worker_32 (!TARGET_64BIT && TARGET_STACK_PROBE)
#define HAVE_allocate_stack_worker_64 (TARGET_64BIT && TARGET_STACK_PROBE)
#define HAVE_trap 1
...
#define HAVE_sse4_2_crc32di (TARGET_SSE4_2 && TARGET_64BIT)
...
#define HAVE_avx_movups (AVX_VEC_FLOAT_MODE_P (V4SFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movupd (AVX_VEC_FLOAT_MODE_P (V2DFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movups256 (AVX_VEC_FLOAT_MODE_P (V8SFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movupd256 (AVX_VEC_FLOAT_MODE_P (V4DFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_sse2_movq128 (TARGET_SSE2)
#define HAVE_sse_movups (SSE_VEC_FLOAT_MODE_P (V4SFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_sse2_movupd (SSE_VEC_FLOAT_MODE_P (V2DFmode) \
   && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movdqu256 (TARGET_AVX && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movdqu (TARGET_AVX && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_sse2_movdqu (TARGET_SSE2 && !(MEM_P (operands[0]) && MEM_P (operands[1])))
#define HAVE_avx_movntv4sf (AVX_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_avx_movntv2df (AVX_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_movntv8sf (AVX_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_avx_movntv4df (AVX_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_sse_movntv4sf (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_movntv2df (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_movntv4di (TARGET_AVX)
#define HAVE_avx_movntv2di (TARGET_AVX)
#define HAVE_sse2_movntv2di (TARGET_SSE2)
#define HAVE_sse2_movntsi (TARGET_SSE2)
#define HAVE_avx_lddqu256 (TARGET_AVX)
#define HAVE_avx_lddqu (TARGET_AVX)
#define HAVE_sse3_lddqu (TARGET_SSE3)
#define HAVE_sse_vmaddv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse_vmsubv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_vmaddv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse2_vmsubv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse_vmmulv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_vmmulv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_divv4sf3 (AVX_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_avx_divv2df3 (AVX_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_divv8sf3 (AVX_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_avx_divv4df3 (AVX_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_sse_divv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_divv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse_vmdivv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_vmdivv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_rcpv8sf2 (TARGET_AVX)
#define HAVE_sse_rcpv4sf2 (TARGET_SSE)
#define HAVE_sse_vmrcpv4sf2 (TARGET_SSE)
#define HAVE_avx_sqrtv8sf2 (TARGET_AVX)
#define HAVE_sse_sqrtv4sf2 (TARGET_SSE)
#define HAVE_sqrtv4df2 (TARGET_AVX)
#define HAVE_sqrtv2df2 (TARGET_SSE2)
#define HAVE_sse_vmsqrtv4sf2 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_vmsqrtv2df2 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_rsqrtv8sf2 (TARGET_AVX)
#define HAVE_sse_rsqrtv4sf2 (TARGET_SSE)
#define HAVE_sse_vmrsqrtv4sf2 (TARGET_SSE)
#define HAVE_sse_vmsmaxv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse_vmsminv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_vmsmaxv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse2_vmsminv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
...
#define HAVE_avx_cmppsv4sf3 (TARGET_AVX)
#define HAVE_avx_cmppdv2df3 (TARGET_AVX)
#define HAVE_avx_cmppsv8sf3 (TARGET_AVX)
#define HAVE_avx_cmppdv4df3 (TARGET_AVX)
#define HAVE_avx_cmpssv4sf3 (TARGET_AVX)
#define HAVE_avx_cmpsdv2df3 (TARGET_AVX)
#define HAVE_sse_maskcmpsf3 ((SSE_FLOAT_MODE_P (SFmode) || SSE_VEC_FLOAT_MODE_P (SFmode)) \
   && !TARGET_SSE5)
#define HAVE_sse2_maskcmpdf3 ((SSE_FLOAT_MODE_P (DFmode) || SSE_VEC_FLOAT_MODE_P (DFmode)) \
   && !TARGET_SSE5)
#define HAVE_sse_maskcmpv4sf3 ((SSE_FLOAT_MODE_P (V4SFmode) || SSE_VEC_FLOAT_MODE_P (V4SFmode)) \
   && !TARGET_SSE5)
#define HAVE_sse2_maskcmpv2df3 ((SSE_FLOAT_MODE_P (V2DFmode) || SSE_VEC_FLOAT_MODE_P (V2DFmode)) \
   && !TARGET_SSE5)
#define HAVE_sse_vmmaskcmpv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode) && !TARGET_SSE5)
#define HAVE_sse2_vmmaskcmpv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode) && !TARGET_SSE5)
...
#define HAVE_avx_andnotv4sf3 (AVX_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_avx_andnotv2df3 (AVX_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_avx_andnotv8sf3 (AVX_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_avx_andnotv4df3 (AVX_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_sse_andnotv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_andnotv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse5_fmaddsf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmadddf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmaddv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmaddv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_vmfmaddv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, true))
#define HAVE_sse5_vmfmaddv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, true))
#define HAVE_sse5_fmsubsf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmsubdf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmsubv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fmsubv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_vmfmsubv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_vmfmsubv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_fnmaddsf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fnmadddf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fnmaddv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_fnmaddv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, true))
#define HAVE_sse5_vmfnmaddv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, true))
#define HAVE_sse5_vmfnmaddv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, true))
#define HAVE_sse5_fnmsubsf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
#define HAVE_sse5_fnmsubdf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
#define HAVE_sse5_fnmsubv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
#define HAVE_sse5_fnmsubv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
#define HAVE_sse5_vmfnmsubv4sf4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
#define HAVE_sse5_vmfnmsubv2df4 (TARGET_SSE5 && TARGET_FUSED_MADD \
   && ix86_sse5_valid_op_p (operands, insn, 4, true, 2, false))
...
#define HAVE_avx_cvtdq2ps (TARGET_AVX)
#define HAVE_avx_cvtdq2ps256 (TARGET_AVX)
#define HAVE_sse2_cvtdq2ps (TARGET_SSE2)
#define HAVE_avx_cvtps2dq (TARGET_AVX)
#define HAVE_avx_cvtps2dq256 (TARGET_AVX)
#define HAVE_sse2_cvtps2dq (TARGET_SSE2)
#define HAVE_avx_cvttps2dq (TARGET_AVX)
#define HAVE_avx_cvttps2dq256 (TARGET_AVX)
...
#define HAVE_avx_cvtdq2pd256 (TARGET_AVX)
#define HAVE_sse2_cvtdq2pd (TARGET_SSE2)
#define HAVE_avx_cvtpd2dq256 (TARGET_AVX)
#define HAVE_avx_cvttpd2dq256 (TARGET_AVX)
...
#define HAVE_vec_extract_lo_v16hi (TARGET_AVX)
#define HAVE_vec_extract_hi_v16hi (TARGET_AVX)
#define HAVE_vec_extract_lo_v32qi (TARGET_AVX)
...
#define HAVE_sse2_gtv16qi3 (TARGET_SSE2 && !TARGET_SSE5)
#define HAVE_sse2_gtv8hi3 (TARGET_SSE2 && !TARGET_SSE5)
#define HAVE_sse2_gtv4si3 (TARGET_SSE2 && !TARGET_SSE5)
...
#define HAVE_avx_movmskps256 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_avx_movmskpd256 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_sse_movmskps (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sse2_movmskpd (SSE_VEC_FLOAT_MODE_P (V2DFmode))
...
#define HAVE_avx_blendps (TARGET_AVX)
#define HAVE_avx_blendpd (TARGET_AVX)
#define HAVE_avx_blendps256 (TARGET_AVX)
#define HAVE_avx_blendpd256 (TARGET_AVX)
#define HAVE_avx_blendvps (TARGET_AVX)
#define HAVE_avx_blendvpd (TARGET_AVX)
#define HAVE_avx_blendvps256 (TARGET_AVX)
#define HAVE_avx_blendvpd256 (TARGET_AVX)
#define HAVE_sse4_1_blendps (TARGET_SSE4_1)
#define HAVE_sse4_1_blendpd (TARGET_SSE4_1)
#define HAVE_sse4_1_blendvps (TARGET_SSE4_1)
#define HAVE_sse4_1_blendvpd (TARGET_SSE4_1)
#define HAVE_avx_dpps (TARGET_AVX)
#define HAVE_avx_dppd (TARGET_AVX)
#define HAVE_avx_dpps256 (TARGET_AVX)
#define HAVE_avx_dppd256 (TARGET_AVX)
#define HAVE_sse4_1_dpps (TARGET_SSE4_1)
#define HAVE_sse4_1_dppd (TARGET_SSE4_1)
...
#define HAVE_sse4_1_extendv8qiv8hi2 (TARGET_SSE4_1)
#define HAVE_sse4_1_extendv4qiv4si2 (TARGET_SSE4_1)
#define HAVE_sse4_1_extendv2qiv2di2 (TARGET_SSE4_1)
#define HAVE_sse4_1_extendv4hiv4si2 (TARGET_SSE4_1)
#define HAVE_sse4_1_extendv2hiv2di2 (TARGET_SSE4_1)
#define HAVE_sse4_1_extendv2siv2di2 (TARGET_SSE4_1)
...
#define HAVE_avx_vtestpd (TARGET_AVX)
...
#define HAVE_avx_roundps256 (TARGET_AVX)
#define HAVE_avx_roundpd256 (TARGET_AVX)
#define HAVE_sse4_1_roundps (TARGET_ROUND)
#define HAVE_sse4_1_roundpd (TARGET_ROUND)
#define HAVE_sse4_1_roundss (TARGET_ROUND)
#define HAVE_sse4_1_roundsd (TARGET_ROUND)
...
#define HAVE_sse5_pmacsww (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 2, true))
#define HAVE_sse5_pmacssww (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmacsdd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 2, true))
#define HAVE_sse5_pmacssdd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmacssdql (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmacssdqh (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmacsdql (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_mulv2div2di3_low (TARGET_SSE5)
#define HAVE_sse5_pmacsdqh (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_mulv2div2di3_high (TARGET_SSE5)
#define HAVE_sse5_pmacsswd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmacswd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmadcsswd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pmadcswd (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, false, 1, true))
#define HAVE_sse5_pcmov_v16qi (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pcmov_v8hi (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pcmov_v4si (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pcmov_v2di (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pcmov_v4sf (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pcmov_v2df (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_phaddbw (TARGET_SSE5)
#define HAVE_sse5_phaddbd (TARGET_SSE5)
#define HAVE_sse5_phaddbq (TARGET_SSE5)
#define HAVE_sse5_phaddwd (TARGET_SSE5)
#define HAVE_sse5_phaddwq (TARGET_SSE5)
#define HAVE_sse5_phadddq (TARGET_SSE5)
#define HAVE_sse5_phaddubw (TARGET_SSE5)
#define HAVE_sse5_phaddubd (TARGET_SSE5)
#define HAVE_sse5_phaddubq (TARGET_SSE5)
#define HAVE_sse5_phadduwd (TARGET_SSE5)
#define HAVE_sse5_phadduwq (TARGET_SSE5)
#define HAVE_sse5_phaddudq (TARGET_SSE5)
#define HAVE_sse5_phsubbw (TARGET_SSE5)
#define HAVE_sse5_phsubwd (TARGET_SSE5)
#define HAVE_sse5_phsubdq (TARGET_SSE5)
#define HAVE_sse5_pperm (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pperm_zero_v16qi_v8hi (TARGET_SSE5 \
   && (register_operand (operands[1], V16QImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_sign_v16qi_v8hi (TARGET_SSE5 \
   && (register_operand (operands[1], V16QImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_zero_v8hi_v4si (TARGET_SSE5 \
   && (register_operand (operands[1], V8HImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_sign_v8hi_v4si (TARGET_SSE5 \
   && (register_operand (operands[1], V8HImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_zero_v4si_v2di (TARGET_SSE5 \
   && (register_operand (operands[1], V4SImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_sign_v4si_v2di (TARGET_SSE5 \
   && (register_operand (operands[1], V4SImode) \
       || register_operand (operands[2], V16QImode)))
#define HAVE_sse5_pperm_pack_v2di_v4si (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pperm_pack_v4si_v8hi (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_pperm_pack_v8hi_v16qi (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_permv4sf (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_permv2df (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 4, true, 1, false))
#define HAVE_sse5_rotlv16qi3 (TARGET_SSE5)
#define HAVE_sse5_rotlv8hi3 (TARGET_SSE5)
#define HAVE_sse5_rotlv4si3 (TARGET_SSE5)
#define HAVE_sse5_rotlv2di3 (TARGET_SSE5)
#define HAVE_sse5_rotrv16qi3 (TARGET_SSE5)
#define HAVE_sse5_rotrv8hi3 (TARGET_SSE5)
#define HAVE_sse5_rotrv4si3 (TARGET_SSE5)
#define HAVE_sse5_rotrv2di3 (TARGET_SSE5)
#define HAVE_sse5_vrotlv16qi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_vrotlv8hi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_vrotlv4si3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_vrotlv2di3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_ashlv16qi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_ashlv8hi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_ashlv4si3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_ashlv2di3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_lshlv16qi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_lshlv8hi3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_lshlv4si3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_lshlv2di3 (TARGET_SSE5 && ix86_sse5_valid_op_p (operands, insn, 3, true, 1, false))
#define HAVE_sse5_frczv4sf2 (TARGET_SSE5)
#define HAVE_sse5_frczv2df2 (TARGET_SSE5)
#define HAVE_sse5_vmfrczv4sf2 (TARGET_SSE5)
#define HAVE_sse5_vmfrczv2df2 (TARGET_SSE5)
#define HAVE_sse5_cvtph2ps (TARGET_SSE5)
#define HAVE_sse5_cvtps2ph (TARGET_SSE5)
#define HAVE_sse5_com_tfv4sf3 (TARGET_SSE5)
#define HAVE_sse5_com_tfv2df3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv4sf3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv2df3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv16qi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv8hi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv4si3 (TARGET_SSE5)
#define HAVE_sse5_maskcmpv2di3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_unsv16qi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_unsv8hi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_unsv4si3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_unsv2di3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_uns2v16qi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_uns2v8hi3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_uns2v4si3 (TARGET_SSE5)
#define HAVE_sse5_maskcmp_uns2v2di3 (TARGET_SSE5)
#define HAVE_sse5_pcom_tfv16qi3 (TARGET_SSE5)
#define HAVE_sse5_pcom_tfv8hi3 (TARGET_SSE5)
#define HAVE_sse5_pcom_tfv4si3 (TARGET_SSE5)
#define HAVE_sse5_pcom_tfv2di3 (TARGET_SSE5)
...
#define HAVE_avx_vzeroupper (TARGET_AVX && !TARGET_64BIT)
#define HAVE_avx_vzeroupper_rex64 (TARGET_AVX && TARGET_64BIT)
...
#define HAVE_avx_vpermilvarv2df3 (TARGET_AVX)
...
#define HAVE_avx_vbroadcastss (TARGET_AVX)
#define HAVE_avx_vbroadcastsd256 (TARGET_AVX)
#define HAVE_avx_vbroadcastss256 (TARGET_AVX)
#define HAVE_avx_vbroadcastf128_ps256 (TARGET_AVX)
#define HAVE_avx_vbroadcastf128_pd256 (TARGET_AVX)
...
#define HAVE_avx_si_si256 (TARGET_AVX)
#define HAVE_avx_ps_ps256 (TARGET_AVX)
#define HAVE_avx_pd_pd256 (TARGET_AVX)
#define HAVE_memory_barrier_nosse (!(TARGET_64BIT || TARGET_SSE2))
...
#define HAVE_cmpsf (TARGET_80387 || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))
#define HAVE_cmpdf (TARGET_80387 || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH))
#define HAVE_movsi 1
#define HAVE_movhi 1
...
#define HAVE_addsf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))
#define HAVE_adddf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH))
...
#define HAVE_subsf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))
#define HAVE_subdf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH))
...
#define HAVE_mulsf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))
#define HAVE_muldf3 (TARGET_80387 || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH))
...
#define HAVE_x86_64_shift_adj_1 (TARGET_64BIT)
#define HAVE_x86_64_shift_adj_2 (TARGET_64BIT)
...
#define HAVE_x86_64_shift_adj_3 1
#define HAVE_x86_shift_adj_3 1
#define HAVE_ashrsi3_31 1
...
#define HAVE_sordered (TARGET_80387 || TARGET_SSE)
...
#define HAVE_ffs_cmove (TARGET_CMOVE)
...
#define HAVE_sqrtsf2 (TARGET_USE_FANCY_MATH_387 \
   || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))
#define HAVE_sqrtdf2 (TARGET_USE_FANCY_MATH_387 \
   || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH))
...
#define HAVE_rintdf2 ((TARGET_USE_FANCY_MATH_387 \
   ...
   || (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH \
       && !flag_trapping_math))
#define HAVE_roundsf2 (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH \
   && !flag_trapping_math && !flag_rounding_math)
#define HAVE_rounddf2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH \
   && !flag_trapping_math && !flag_rounding_math)
...
#define HAVE_lrintdfdi2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH \
   && ((DImode != DImode) || TARGET_64BIT))
#define HAVE_lroundsfsi2 (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH \
   && ((SImode != DImode) || TARGET_64BIT) \
   && !flag_trapping_math && !flag_rounding_math)
#define HAVE_lrounddfsi2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH \
   && ((SImode != DImode) || TARGET_64BIT) \
   && !flag_trapping_math && !flag_rounding_math)
#define HAVE_lroundsfdi2 (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH \
   && ((DImode != DImode) || TARGET_64BIT) \
   && !flag_trapping_math && !flag_rounding_math)
#define HAVE_lrounddfdi2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH \
   && ((DImode != DImode) || TARGET_64BIT) \
   && !flag_trapping_math && !flag_rounding_math)
...
#define HAVE_lfloorxfdi2 (TARGET_USE_FANCY_MATH_387 \
   && (!TARGET_SSE_MATH || TARGET_MIX_SSE_I387) \
   && flag_unsafe_math_optimizations)
#define HAVE_lfloorsfdi2 (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH && TARGET_64BIT \
   && !flag_trapping_math)
#define HAVE_lfloordfdi2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH && TARGET_64BIT \
   && !flag_trapping_math)
...
#define HAVE_lceilxfdi2 (TARGET_USE_FANCY_MATH_387 \
   && (!TARGET_SSE_MATH || TARGET_MIX_SSE_I387) \
   && flag_unsafe_math_optimizations)
#define HAVE_lceilsfdi2 (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH && TARGET_64BIT \
   && !flag_trapping_math)
#define HAVE_lceildfdi2 (SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH && TARGET_64BIT \
   && !flag_trapping_math)
...
#define HAVE_movv32qi (TARGET_AVX)
#define HAVE_movv16hi (TARGET_AVX)
#define HAVE_movv8si (TARGET_AVX)
#define HAVE_movv4di (TARGET_AVX)
#define HAVE_movv8sf (TARGET_AVX)
#define HAVE_movv4df (TARGET_AVX)
...
#define HAVE_pushv32qi1 (TARGET_AVX)
#define HAVE_pushv16hi1 (TARGET_AVX)
#define HAVE_pushv8si1 (TARGET_AVX)
#define HAVE_pushv4di1 (TARGET_AVX)
#define HAVE_pushv8sf1 (TARGET_AVX)
#define HAVE_pushv4df1 (TARGET_AVX)
...
#define HAVE_movmisalignv32qi (TARGET_AVX)
#define HAVE_movmisalignv16hi (TARGET_AVX)
#define HAVE_movmisalignv8si (TARGET_AVX)
#define HAVE_movmisalignv4di (TARGET_AVX)
#define HAVE_movmisalignv8sf (TARGET_AVX)
#define HAVE_movmisalignv4df (TARGET_AVX)
...
#define HAVE_storentv4sf (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_storentv2df (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_storentsf (TARGET_SSE4A)
#define HAVE_storentdf (TARGET_SSE4A)
#define HAVE_storentv2di (TARGET_SSE2)
#define HAVE_storentsi (TARGET_SSE2)
#define HAVE_absv4sf2 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_negv4sf2 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_absv2df2 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_negv2df2 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_addv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_subv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_addv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_subv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_addv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_subv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_addv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_subv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_mulv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_mulv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_mulv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_mulv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_divv8sf3 (TARGET_AVX)
#define HAVE_divv4df3 (TARGET_AVX)
#define HAVE_divv4sf3 (TARGET_SSE)
#define HAVE_divv2df3 (TARGET_SSE2)
#define HAVE_sqrtv8sf2 (TARGET_AVX)
#define HAVE_sqrtv4sf2 (TARGET_SSE)
#define HAVE_rsqrtv8sf2 (TARGET_AVX && TARGET_SSE_MATH)
#define HAVE_rsqrtv4sf2 (TARGET_SSE_MATH)
#define HAVE_smaxv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_sminv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_smaxv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_sminv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_smaxv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_sminv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_smaxv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sminv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
...
#define HAVE_vcondv4sf (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_vcondv2df (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_andv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_iorv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_xorv8sf3 (AVX256_VEC_FLOAT_MODE_P (V8SFmode))
#define HAVE_andv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_iorv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_xorv4df3 (AVX256_VEC_FLOAT_MODE_P (V4DFmode))
#define HAVE_andv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_iorv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_xorv4sf3 (SSE_VEC_FLOAT_MODE_P (V4SFmode))
#define HAVE_andv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_iorv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_xorv2df3 (SSE_VEC_FLOAT_MODE_P (V2DFmode))
#define HAVE_sse5i_fmaddv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_fmaddv2df4 (TARGET_SSE5)
#define HAVE_sse5i_fmsubv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_fmsubv2df4 (TARGET_SSE5)
#define HAVE_sse5i_fnmaddv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_fnmaddv2df4 (TARGET_SSE5)
#define HAVE_sse5i_fnmsubv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_fnmsubv2df4 (TARGET_SSE5)
#define HAVE_sse5i_vmfmaddv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_vmfmaddv2df4 (TARGET_SSE5)
#define HAVE_sse5i_vmfmsubv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_vmfmsubv2df4 (TARGET_SSE5)
#define HAVE_sse5i_vmfnmaddv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_vmfnmaddv2df4 (TARGET_SSE5)
#define HAVE_sse5i_vmfnmsubv4sf4 (TARGET_SSE5)
#define HAVE_sse5i_vmfnmsubv2df4 (TARGET_SSE5)
...
#define HAVE_sse2_unpckhpd_exp (TARGET_SSE2)
#define HAVE_sse2_unpcklpd_exp (TARGET_SSE2)
#define HAVE_avx_shufpd256 (TARGET_AVX)
#define HAVE_sse2_shufpd (TARGET_SSE2)
#define HAVE_vec_extract_evenv4sf (TARGET_SSE)
#define HAVE_vec_extract_evenv4si (TARGET_SSE)
#define HAVE_vec_extract_oddv4sf (TARGET_SSE)
#define HAVE_vec_extract_oddv4si (TARGET_SSE)
#define HAVE_vec_extract_evenv2df (TARGET_SSE2)
#define HAVE_vec_extract_evenv2di (TARGET_SSE2)
#define HAVE_vec_extract_oddv2df (TARGET_SSE2)
#define HAVE_vec_extract_oddv2di (TARGET_SSE2)
...
#define HAVE_vec_widen_smult_hi_v4si (TARGET_SSE5)
#define HAVE_vec_widen_smult_lo_v4si (TARGET_SSE5)
...
#define HAVE_sse2_eqv16qi3 (TARGET_SSE2 && !TARGET_SSE5)
#define HAVE_sse2_eqv8hi3 (TARGET_SSE2 && !TARGET_SSE5)
#define HAVE_sse2_eqv4si3 (TARGET_SSE2 && !TARGET_SSE5)
...
#define HAVE_vcondv2di ((TARGET_SSE2) && (TARGET_SSE4_2 || TARGET_SSE5))
#define HAVE_vconduv16qi (TARGET_SSE2)
#define HAVE_vconduv8hi (TARGET_SSE2)
#define HAVE_vconduv4si (TARGET_SSE2)
#define HAVE_vconduv2di ((TARGET_SSE2) && (TARGET_SSE4_2 || TARGET_SSE5))
...
#define HAVE_rotlv16qi3 (TARGET_SSE5)
#define HAVE_rotlv8hi3 (TARGET_SSE5)
#define HAVE_rotlv4si3 (TARGET_SSE5)
#define HAVE_rotlv2di3 (TARGET_SSE5)
#define HAVE_rotrv16qi3 (TARGET_SSE5)
#define HAVE_rotrv8hi3 (TARGET_SSE5)
#define HAVE_rotrv4si3 (TARGET_SSE5)
#define HAVE_rotrv2di3 (TARGET_SSE5)
#define HAVE_vrotrv16qi3 (TARGET_SSE5)
#define HAVE_vrotrv8hi3 (TARGET_SSE5)
#define HAVE_vrotrv4si3 (TARGET_SSE5)
#define HAVE_vrotrv2di3 (TARGET_SSE5)
#define HAVE_vrotlv16qi3 (TARGET_SSE5)
#define HAVE_vrotlv8hi3 (TARGET_SSE5)
#define HAVE_vrotlv4si3 (TARGET_SSE5)
#define HAVE_vrotlv2di3 (TARGET_SSE5)
#define HAVE_vlshrv16qi3 (TARGET_SSE5)
#define HAVE_vlshrv8hi3 (TARGET_SSE5)
#define HAVE_vlshrv4si3 (TARGET_SSE5)
#define HAVE_vashrv16qi3 (TARGET_SSE5)
#define HAVE_vashrv8hi3 (TARGET_SSE5)
#define HAVE_vashrv4si3 (TARGET_SSE5)
#define HAVE_vashlv16qi3 (TARGET_SSE5)
#define HAVE_vashlv8hi3 (TARGET_SSE5)
#define HAVE_vashlv4si3 (TARGET_SSE5)
#define HAVE_ashlv16qi3 (TARGET_SSE5)
#define HAVE_lshlv16qi3 (TARGET_SSE5)
#define HAVE_ashrv16qi3 (TARGET_SSE5)
#define HAVE_ashrv2di3 (TARGET_SSE5)
#define HAVE_sse5_vmmaskcmpv4sf3 (TARGET_SSE5)
#define HAVE_sse5_vmmaskcmpv2df3 (TARGET_SSE5)
...
extern rtx        gen_sse5_fmaddsf4                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmadddf4                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmaddv4sf4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmaddv2df4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfmaddv4sf4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfmaddv2df4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmsubsf4                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmsubdf4                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmsubv4sf4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fmsubv2df4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfmsubv4sf4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfmsubv2df4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmaddsf4                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmadddf4                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmaddv4sf4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmaddv2df4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfnmaddv4sf4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfnmaddv2df4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmsubsf4                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmsubdf4                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmsubv4sf4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_fnmsubv2df4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfnmsubv4sf4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmfnmsubv2df4                (rtx, rtx, rtx, rtx);
...
extern rtx        gen_sse5_pmacsww                      (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacssww                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacsdd                      (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacssdd                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacssdql                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacssdqh                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacsdql                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_mulv2div2di3_low             (rtx, rtx, rtx);
extern rtx        gen_sse5_pmacsdqh                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_mulv2div2di3_high            (rtx, rtx, rtx);
extern rtx        gen_sse5_pmacsswd                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmacswd                      (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmadcsswd                    (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pmadcswd                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v16qi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v8hi                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v4si                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v2di                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v4sf                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcmov_v2df                   (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_phaddbw                      (rtx, rtx);
extern rtx        gen_sse5_phaddbd                      (rtx, rtx);
extern rtx        gen_sse5_phaddbq                      (rtx, rtx);
extern rtx        gen_sse5_phaddwd                      (rtx, rtx);
extern rtx        gen_sse5_phaddwq                      (rtx, rtx);
extern rtx        gen_sse5_phadddq                      (rtx, rtx);
extern rtx        gen_sse5_phaddubw                     (rtx, rtx);
extern rtx        gen_sse5_phaddubd                     (rtx, rtx);
extern rtx        gen_sse5_phaddubq                     (rtx, rtx);
extern rtx        gen_sse5_phadduwd                     (rtx, rtx);
extern rtx        gen_sse5_phadduwq                     (rtx, rtx);
extern rtx        gen_sse5_phaddudq                     (rtx, rtx);
extern rtx        gen_sse5_phsubbw                      (rtx, rtx);
extern rtx        gen_sse5_phsubwd                      (rtx, rtx);
extern rtx        gen_sse5_phsubdq                      (rtx, rtx);
extern rtx        gen_sse5_pperm                        (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_zero_v16qi_v8hi        (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_sign_v16qi_v8hi        (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_zero_v8hi_v4si         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_sign_v8hi_v4si         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_zero_v4si_v2di         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_sign_v4si_v2di         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_pack_v2di_v4si         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_pack_v4si_v8hi         (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pperm_pack_v8hi_v16qi        (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_permv4sf                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_permv2df                     (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_rotlv16qi3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_rotlv8hi3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_rotlv4si3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_rotlv2di3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_rotrv16qi3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_rotrv8hi3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_rotrv4si3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_rotrv2di3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_vrotlv16qi3                  (rtx, rtx, rtx);
extern rtx        gen_sse5_vrotlv8hi3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_vrotlv4si3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_vrotlv2di3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_ashlv16qi3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_ashlv8hi3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_ashlv4si3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_ashlv2di3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_lshlv16qi3                   (rtx, rtx, rtx);
extern rtx        gen_sse5_lshlv8hi3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_lshlv4si3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_lshlv2di3                    (rtx, rtx, rtx);
extern rtx        gen_sse5_frczv4sf2                    (rtx, rtx);
extern rtx        gen_sse5_frczv2df2                    (rtx, rtx);
extern rtx        gen_sse5_vmfrczv4sf2                  (rtx, rtx, rtx);
extern rtx        gen_sse5_vmfrczv2df2                  (rtx, rtx, rtx);
extern rtx        gen_sse5_cvtph2ps                     (rtx, rtx);
extern rtx        gen_sse5_cvtps2ph                     (rtx, rtx);
extern rtx        gen_sse5_com_tfv4sf3                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_com_tfv2df3                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv4sf3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv2df3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv16qi3                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv8hi3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv4si3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmpv2di3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_unsv16qi3            (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_unsv8hi3             (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_unsv4si3             (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_unsv2di3             (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_uns2v16qi3           (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_uns2v8hi3            (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_uns2v4si3            (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_maskcmp_uns2v2di3            (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcom_tfv16qi3                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcom_tfv8hi3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcom_tfv4si3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_pcom_tfv2di3                 (rtx, rtx, rtx, rtx);
...
extern rtx        gen_avx_vzeroupper_rex64              (void);
...
extern rtx        gen_avx_vbroadcastss                  (rtx, rtx);
extern rtx        gen_avx_vbroadcastsd256               (rtx, rtx);
extern rtx        gen_avx_vbroadcastss256               (rtx, rtx);
extern rtx        gen_avx_vbroadcastf128_ps256          (rtx, rtx);
extern rtx        gen_avx_vbroadcastf128_pd256          (rtx, rtx);
...
extern rtx        gen_sse5i_fmaddv4sf4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fmaddv2df4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fmsubv4sf4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fmsubv2df4                  (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fnmaddv4sf4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fnmaddv2df4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fnmsubv4sf4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_fnmsubv2df4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfmaddv4sf4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfmaddv2df4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfmsubv4sf4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfmsubv2df4                (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfnmaddv4sf4               (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfnmaddv2df4               (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfnmsubv4sf4               (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5i_vmfnmsubv2df4               (rtx, rtx, rtx, rtx);
...
extern rtx        gen_sse2_unpckhpd_exp                 (rtx, rtx, rtx);
extern rtx        gen_sse2_unpcklpd_exp                 (rtx, rtx, rtx);
...
extern rtx        gen_sse5_vmmaskcmpv4sf3               (rtx, rtx, rtx, rtx);
extern rtx        gen_sse5_vmmaskcmpv2df3               (rtx, rtx, rtx, rtx);
