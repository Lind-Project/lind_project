...
extern int const_pow2_1_to_2_operand (rtx, enum machine_mode);
extern int const_pow2_1_to_8_operand (rtx, enum machine_mode);
extern int const_pow2_1_to_128_operand (rtx, enum machine_mode);
extern int const_pow2_1_to_32768_operand (rtx, enum machine_mode);
...
extern int avx_comparison_float_operator (rtx, enum machine_mode);
extern int sse5_comparison_float_operator (rtx, enum machine_mode);
