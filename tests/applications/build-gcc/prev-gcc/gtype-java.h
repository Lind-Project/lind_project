  ...
  while (x != xlimit)
    {
      switch (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE)
        ...
        case 0:
          ...
          break;
        case 1:
          gt_ggc_m_10tree_ann_d ((*x).identifier.ignore.common.base.ann);
  ...
  while (x != xlimit)
    {
      switch (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE)
        ...
        case 0:
          ...
          break;
        case 1:
          gt_pch_n_10tree_ann_d ((*x).identifier.ignore.common.base.ann);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE)
    ...
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).identifier.ignore.common.base.ann), cookie);
      if ((void *)(x) == this_obj)
