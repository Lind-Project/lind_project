...
enum machine_mode
{
  ...
  OImode,                  /* config/i386/i386-modes.def:89 */
  ...
  V2QImode,                /* config/i386/i386-modes.def:82 */
  V4QImode,                /* config/i386/i386-modes.def:73 */
  V2HImode,                /* config/i386/i386-modes.def:73 */
  V1SImode,                /* config/i386/i386-modes.def:81 */
  V8QImode,                /* config/i386/i386-modes.def:74 */
  V4HImode,                /* config/i386/i386-modes.def:74 */
  V2SImode,                /* config/i386/i386-modes.def:74 */
  V1DImode,                /* config/i386/i386-modes.def:80 */
  V16QImode,               /* config/i386/i386-modes.def:75 */
  V8HImode,                /* config/i386/i386-modes.def:75 */
  V4SImode,                /* config/i386/i386-modes.def:75 */
  V2DImode,                /* config/i386/i386-modes.def:75 */
  V32QImode,               /* config/i386/i386-modes.def:76 */
  V16HImode,               /* config/i386/i386-modes.def:76 */
  V8SImode,                /* config/i386/i386-modes.def:76 */
  V4DImode,                /* config/i386/i386-modes.def:76 */
  V2TImode,                /* config/i386/i386-modes.def:76 */
  V64QImode,               /* config/i386/i386-modes.def:85 */
  V32HImode,               /* config/i386/i386-modes.def:84 */
  V8DImode,                /* config/i386/i386-modes.def:83 */
  V2SFmode,                /* config/i386/i386-modes.def:77 */
  V4SFmode,                /* config/i386/i386-modes.def:78 */
  V2DFmode,                /* config/i386/i386-modes.def:78 */
  V8SFmode,                /* config/i386/i386-modes.def:79 */
  V4DFmode,                /* config/i386/i386-modes.def:79 */
  V2TFmode,                /* config/i386/i386-modes.def:79 */
  V16SFmode,               /* config/i386/i386-modes.def:87 */
  V8DFmode,                /* config/i386/i386-modes.def:86 */
  MAX_MACHINE_MODE,
