...
#define MASK_CLD (1 << 4)
#define OPTION_MASK_ISA_CX16 (1 << 6)
#define OPTION_MASK_ISA_FMA (1 << 7)
#define MASK_FLOAT_RETURNS (1 << 5)
#define MASK_IEEE_FP (1 << 6)
#define MASK_INLINE_ALL_STRINGOPS (1 << 7)
#define MASK_INLINE_STRINGOPS_DYNAMICALLY (1 << 8)
#define OPTION_MASK_ISA_MMX (1 << 8)
#define MASK_MS_BITFIELD_LAYOUT (1 << 9)
#define MASK_NO_ALIGN_STRINGOPS (1 << 10)
#define MASK_NO_FANCY_MATH_387 (1 << 11)
#define MASK_NO_FUSED_MADD (1 << 12)
#define MASK_NO_PUSH_ARGS (1 << 13)
#define MASK_NO_RED_ZONE (1 << 14)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 15)
#define OPTION_MASK_ISA_PCLMUL (1 << 9)
#define OPTION_MASK_ISA_POPCNT (1 << 10)
#define MASK_RECIP (1 << 16)
#define MASK_RTD (1 << 17)
#define OPTION_MASK_ISA_SAHF (1 << 11)
#define OPTION_MASK_ISA_SSE (1 << 12)
#define OPTION_MASK_ISA_SSE2 (1 << 13)
#define OPTION_MASK_ISA_SSE3 (1 << 14)
#define OPTION_MASK_ISA_SSE4_1 (1 << 15)
#define OPTION_MASK_ISA_SSE4_2 (1 << 16)
#define OPTION_MASK_ISA_SSE4A (1 << 17)
#define OPTION_MASK_ISA_SSE5 (1 << 18)
#define MASK_SSEREGPARM (1 << 18)
#define OPTION_MASK_ISA_SSSE3 (1 << 19)
...
#define TARGET_NO_FUSED_MADD ((target_flags & MASK_NO_FUSED_MADD) != 0)
...
#define OPTION_ISA_SSE5 ((ix86_isa_flags & OPTION_MASK_ISA_SSE5) != 0)
...
enum opt_code
{
  ...
  OPT_mno_fused_madd,                        /* -mno-fused-madd */
