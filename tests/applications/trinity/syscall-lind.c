...
long mkcall(int call)
{
	...
	olda1 = (unsigned long)rand64();
	olda2 = (unsigned long)rand64();
	olda3 = (unsigned long)rand64();
	olda4 = (unsigned long)rand64();
	olda5 = (unsigned long)rand64();
	olda6 = (unsigned long)rand64();
