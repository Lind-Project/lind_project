...
/usr/local/gcc-4.4.3/bin/gcc scripts/unsafe-pipe.o /home/lind/lind_project/tests/native-rustposix/tests/lind_platform.o -L/home/lind/lind_project/lind/lindenv -lrustposix -o scripts/unsafe-pipe -O3 -lpthread
