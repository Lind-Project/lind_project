...
echo "Compile"
x86_64-nacl-gcc two-process-write-namedpp.c -o /home/lind/lind_project/src/safeposix-rust/tmp/two-process-write-namedpp.nexe -lpthread -O3
x86_64-nacl-gcc two-process-read-namedpp.c -o /home/lind/lind_project/src/safeposix-rust/tmp/two-process-read-namedpp.nexe -lpthread -O3
x86_64-nacl-gcc one-proces-namedpp.c -o /home/lind/lind_project/src/safeposix-rust/tmp/one-proces-namedpp.nexe -lpthread -O3
