...
parser = argparse.ArgumentParser(description="Script to benchmark piping 16GB varying buffersize in userspace")
...
def execute_script(write_buffer_size, read_buffer_size):
    process = subprocess.call(["./scripts/userpipetest", write_buffer_size, read_buffer_size])
