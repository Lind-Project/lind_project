...
x86_64-nacl-gcc scripts/loopback.c -o scripts/loopback.nexe -lrt -std=gnu99 -O3 -lpthread
...
lindfs cp /home/lind/lind_project/tests/ipc_performance/buf_allocate/scripts/loopback.nexe /loopback
...
/usr/local/gcc-4.4.3/bin/gcc scripts/loopback.c -o scripts/loopback -lrt -std=gnu99 -O3 -lpthread
