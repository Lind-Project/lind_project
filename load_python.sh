...
do
    sudo cp /home/lind/lind_project/tests/applications/python-native-gcc4/python-gcc4/build/lib/$lib.so /usr/local/python-gcc4/lib/python2.7/lib-dynload/$lib.so
done
...
sudo cp /home/lind/lind_project/tests/applications/python-native-gcc4/python-gcc4/build/lib/_hashlib.so /usr/local/python-gcc4/lib/python2.7/lib-dynload/_hashlib.so
sudo cp /home/lind/lind_project/tests/applications/python-native-gcc4/python-gcc4/build/lib/_ctypes.so /usr/local/python-gcc4/lib/python2.7/lib-dynload/_ctypes.so
...
sudo cp /home/lind/lind_project/tests/applications/python-native-gcc4/python-modules/psycopg2/lib/* /usr/local/python-gcc4/lib/python2.7/lib-dynload/psycopg2/
